...
/****** Object:  Database [mydata]    Script Date: 15/06/2021 10:56:48 PM ******/
CREATE DATABASE [mydata]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'mydata', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\mydata.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'mydata_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\mydata_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
GO
/****** Object:  Table [dbo].[RentedMovies]    Script Date: 15/06/2021 10:56:48 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  View [dbo].[PopularVideo]    Script Date: 15/06/2021 10:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[PopularVideo]
AS
SELECT        TOP (100) PERCENT COUNT(m.Title) AS Times_Rented, m.Title
FROM            dbo.RentedMovies AS r INNER JOIN
                         dbo.Movies AS m ON r.MovieIDFK = m.MovieID
GROUP BY m.Title
ORDER BY Times_Rented DESC
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 15/06/2021 10:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[PopularCustomer]    Script Date: 15/06/2021 10:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[PopularCustomer]
AS
SELECT        TOP (100) PERCENT COUNT(c.CustID) AS Movies_Rented, c.FirstName, c.LastName
FROM            dbo.Customer AS c INNER JOIN
                         dbo.RentedMovies AS rm ON c.CustID = rm.CustIDFK INNER JOIN
                         dbo.Movies AS m ON m.MovieID = rm.MovieIDFK
WHERE        (c.CustID = c.CustID)
GROUP BY c.FirstName, c.LastName
ORDER BY COUNT(c.CustID) DESC
GO
...
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (1, N'4.5', N'Henry IV, Part 1', N'2018', 5.0000, N'6', N'1403:- Henry IV finds himself facing uprisings from the Welsh chieftain Owen Glendower and impetuous young Harry Hotspur,son of the Duke of Northumberland,angry with the king for not paying...        ', N'Action')
...
INSERT [dbo].[RentedMovies] ([RMID], [MovieIDFK], [CustIDFK], [DateRented], [DateReturned]) VALUES (11, 8, 5, CAST(N'2014-04-14T09:53:50.243' AS DateTime), CAST(N'2019-09-26T22:00:29.270' AS DateTime))
INSERT [dbo].[RentedMovies] ([RMID], [MovieIDFK], [CustIDFK], [DateRented], [DateReturned]) VALUES (12, 2, 5, CAST(N'2019-09-26T22:00:19.497' AS DateTime), NULL)
INSERT [dbo].[RentedMovies] ([RMID], [MovieIDFK], [CustIDFK], [DateRented], [DateReturned]) VALUES (13, 3, 4, CAST(N'2019-09-26T22:53:48.277' AS DateTime), CAST(N'2019-09-26T22:54:11.067' AS DateTime))
INSERT [dbo].[RentedMovies] ([RMID], [MovieIDFK], [CustIDFK], [DateRented], [DateReturned]) VALUES (14, 4, 1, CAST(N'2019-09-26T22:54:01.053' AS DateTime), NULL)
...
GO
/****** Object:  StoredProcedure [dbo].[DeleteMovie]    Script Date: 15/06/2021 10:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'PopularCustomer'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'PopularCustomer'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'PopularVideo'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'PopularVideo'
GO
USE [master]
GO
