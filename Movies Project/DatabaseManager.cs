...
namespace Movies_Project
{
    ...
    {
        public string str = "Data Source=DESKTOP-J8NDLG6\\SQLEXPRESS01;Initial Catalog=mydata;Integrated Security=True";
       
        SqlCommand SqlStr = new SqlCommand();
        SqlDataReader SqlReader;
        String SqlStmt;
        SqlConnection SqlConn = new SqlConnection("Data Source=DESKTOP-J8NDLG6\\SQLEXPRESS01;Initial Catalog=mydata;Integrated Security=True");
